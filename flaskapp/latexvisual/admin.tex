...
\section{\color{hmcorange}Atividades E Eventos}\subsection{Maio}\textbf{04}\quad \quad \quad \quad ex2 \newline\textbf{08}\quad \quad \quad \quad exemplo \newline\subsection{Junho}\textbf{03 a 11}\quad \quad exemplo 2 \newline\end{poster}
\end{document}