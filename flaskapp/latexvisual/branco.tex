...
\subsection{Maio \hfill 18 dias letivos}\textbf{11}\qquad Data limite para \underline{publicação} da \textbf{primeira nota bimestral} e \underline{lançamento} no sistema acadêmico \newline \null\subsection{Junho \hfill 22 dias letivos}\textbf{03}\qquad Data limite para divulgação dos resultados do \textbf{exame de suficiência} em disciplinas/unidades curriculares \newline \null\newpage
...
\columnbreak
\section{\hfill \color{hmcorange}1º Semestre}
								\subsection{Maio \hfill 18 dias letivos}\subsection{Junho \hfill 22 dias letivos}\newpage
...
\columnbreak
\section{\hfill \color{hmcorange}2º Semestre}
							\subsection{Outubro \hfill 20 dias letivos}\subsection{Novembro \hfill 24 dias letivos}\subsection{Dezembro \hfill 14 dias letivos}\newpage
~
\vfill
\begin{center}
